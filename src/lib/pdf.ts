...
// Example usage function to integrate with your existing form
export function createPDFFromFormData(
  roomDetails: RoomDetails[],
  shutterDetails: ShutterDetails[],
  rollerBlindDetails: RollerBlindDetails,
  addons: Addon[],
  ...
  wantsRollerBlinds: boolean,
  wantsDiscount: boolean,
  calculateTotalWithAddons: () => number,
  ...
  const quoteData: QuoteData = {
    ...
    wantsRollerBlinds,
    wantsDiscount,
    subtotal: calculateTotalWithAddons(),
    finalTotal: calculateFinalTotal(),
  }

  return generatePDFQuote(quoteData)
}

export async function downloadPDF(
  blob: Blob,
  filename: string = 'curtain-quote.pdf',
): Promise<void> {
