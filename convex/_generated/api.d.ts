...
export declare const components: {
	agent: {
		...
		files: {
			...
			deleteFiles: FunctionReference<'mutation', 'internal', { fileIds: Array<string>; force?: boolean }, Array<string>>
				...
				'internal',
				{
					...
					messages: Array<{
						...
						reasoningDetails?: Array<
							{ signature?: string; text: string; type: 'text' } | { data: string; type: 'redacted' }
						>
						sources?: Array<{
							id: string
							providerOptions?: Record<string, Record<string, any>>
		...
		streams: {
			abort: FunctionReference<'mutation', 'internal', { reason: string; streamId: string }, boolean>
